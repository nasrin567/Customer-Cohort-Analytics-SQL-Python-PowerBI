...
I'm an aspiring **Data Analyst** passionate about building end-to-end analytics projects using **Python, SQL Server, and Power BI**. I enjoy transforming raw data into meaningful insights through data cleaning, SQL analysis, and interactive dashboard development.
